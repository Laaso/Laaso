...
// All routes in timber are lowercase, so setting this to true will
// make it such that users much only use lowercase urls. Not recommended for good UX.
app.set('case sensitive routing', false);

// Proxies to trust.
// By default, Timber will trust localhost, as many hosting it will have
...
// Cloudflare
// Uncomment this if you are using Cloudflare to protect your Timber instance.
